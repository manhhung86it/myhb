 ...
 */
/*
$pie_colors = array(__("Transparent", 'wpb') => 'transparent', __("Light", 'wpb') => 'light', __("Dark", 'wpb') => 'dark', __('Green', 'wpb') => 'green', __('Turquoise', 'wpb') => 'turquoise', __('Purple', 'wpb') => 'purple', __('Pink', 'wpb') => 'pink', __('Orange', 'wpb') => 'orange', __('Light Grey', 'wpb') => 'light-grey' );
wpb_map( array(
