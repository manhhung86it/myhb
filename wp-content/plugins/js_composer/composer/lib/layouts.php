...
class WPBakeryVisualComposerTemplate_r extends WPBakeryVisualComposerAbstract {
    ...
    protected function getTemplates() {
        ...
        if(!empty($this->templates)) {
            if(!get_magic_quotes_gpc() && get_option('wpb_js_composer_templates_slashes_updated') !== 'yes') {
                add_option('wpb_js_composer_templates_slashes_updated', 'yes');
            } elseif(get_magic_quotes_gpc() && get_option('wpb_js_composer_templates_slashes_updated') !== 'yes') {
                add_option('wpb_js_composer_templates_slashes_updated', 'yes');
                $new_templates = array();
