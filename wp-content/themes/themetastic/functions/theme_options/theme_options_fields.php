 ...
 * Checkbox
 * ------------------------------------------------------------------------ */  
	function themetastic_checkbox_callback($args) {
		// Extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
	...
	} // end themetastic_checkbox_callback

/* ------------------------------------------------------------------------ *
 * Input URL
 * ------------------------------------------------------------------------ */ 
	function themetastic_input_url_callback($args) {
	...
	} // end themetastic_input_url_callback


/* ------------------------------------------------------------------------ *
 * Input
 * ------------------------------------------------------------------------ */ 
	function themetastic_input_callback($args) {
		...
		echo '<br><span class="description">' . $desc . '</span>';
	} // end themetastic_input_element_callback


/* ------------------------------------------------------------------------ *
 * Textarea
 * ------------------------------------------------------------------------ */ 
	function themetastic_textarea_callback($args) {
	...
	} // end themetastic_textarea_callback


/* ------------------------------------------------------------------------ *
 * Radio
 * ------------------------------------------------------------------------ */ 
	function themetastic_radio_callback($args) {
		// First, extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
		...
		echo '<br><span class="description">' . $desc . '</span>';
	} // end themetastic_radio_callback

/* ------------------------------------------------------------------------ *
 * Select
 * ------------------------------------------------------------------------ */ 
	 function themetastic_select_callback($args) {
	...
	} // end themetastic_radio_element_callback

/* ------------------------------------------------------------------------ *
 * ColorSelect
 * ------------------------------------------------------------------------ */ 
	 function themetastic_selectColor_callback($args) {
 ...
 * Select Page
 * ------------------------------------------------------------------------ */ 
	 function themetastic_selectpage_callback($args) {
 ...
 * Color
 * ------------------------------------------------------------------------ */ 
	function themetastic_color_callback($args) {
 ...
 * Sidebar Builder
 * ------------------------------------------------------------------------ */ 
	 function themetastic_sidebar_build_callback($args) {
		 // First, extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
	...
	} // end themetastic_sidebar_callback
	
/* ------------------------------------------------------------------------ *
 * Sidebar Chooser
 * ------------------------------------------------------------------------ */ 
	 function themetastic_sidebar_choose_callback($args) {
		 // First, extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
	...
	function themetastic_html_callback($args){
		 // First, extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
 ...
 * ------------------------------------------------------------------------ */ 
	 function themetastic_sidebar_mandotory_choose_callback($args) {
		 // First, extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
 ...
 * Image
 * ------------------------------------------------------------------------ */ 
	function themetastic_image_callback($args) {
 ...
 * Portfolio Builder
 * ------------------------------------------------------------------------ */ 
	 function themetastic_portfolio_build_callback($args) {
		 // First, extract $args
		$name = $args[0];
		$section = $args[1];
		$desc = $args[2];
