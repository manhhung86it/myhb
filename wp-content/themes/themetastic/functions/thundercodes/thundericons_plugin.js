...
function writeIcons(){
		var form = jQuery('<style>.retina-icons li:hover span { color:#000 !important; cursor: pointer !important } .retina-icons li {width: 22%;display: block;margin-right: 3%;float: left;line-height: 30px;}.retina-icons li span{color:#aaa;};.retina-icons li span:before {content:"\a"}</style><div id="thundercodes-form"><ul class="retina-icons">\
		...
		W = W - 80;
		H = H - 184;
		tb_show( 'themetasticIcons', '#TB_inline?width=' + W + '&height=' + H + '&inlineId=thundercodes-form' );
...
function sendIcon(daclass){
	tinyMCE.activeEditor.execCommand('mceInsertContent', 0, "[themetasticicon icon='"+daclass+"' size='15px' class='']");
	// closes Thickbox
	tb_remove();
}